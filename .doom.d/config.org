...
* BOOKMARKS AND BUFFERS
  :PROPERTIES:
  :CUSTOM_ID: bookmarks-and-buffers
  :END:
...
* EVALUATE ELISP EXPRESSIONS
  :PROPERTIES:
  :CUSTOM_ID: evaluate-elisp-expressions
  :END:
...
(setq doom-font (font-spec :family "Fira Code" :size 15)
      doom-variable-pitch-font (font-spec :family "Nunitio" :size 15)
