local snippets_lsp = require 'snippets'
local utils = require 'snippets.utils'

snippets_lsp.use_suggested_mappings(true)

snippets_lsp._global = {
    ...
    copyright = utils.force_comment [[Copyright (C) Geet Sethi ${=os.date("%Y")}]]
}
