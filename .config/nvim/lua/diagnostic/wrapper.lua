...
vim.api.nvim_create_user_command(
  "DiagnosticGetAll",
  function() vim.diagnostic.get() end,
  { desc = "Get all the available diagnostics" }
)
vim.api.nvim_create_user_command(
  "DiagnosticGetNext",
  function() vim.diagnostic.get_next() end,
  { desc = "Get the next diagnostic" }
)
vim.api.nvim_create_user_command(
  "DiagnosticGetPrev",
  function() vim.diagnostic.get_prev() end,
  { desc = "Get the previous diagnostic" }
)
