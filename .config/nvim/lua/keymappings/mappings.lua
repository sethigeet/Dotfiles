...
for _, value in ipairs({"t", "i"}) do
    vim.api.nvim_set_keymap(value, "<M-h>", [[<C-\><C-N><C-w>h]],
                            {noremap = true, silent = true})
    vim.api.nvim_set_keymap(value, "<M-j>", [[<C-\><C-N><C-w>j]],
                            {noremap = true, silent = true})
    vim.api.nvim_set_keymap(value, "<M-k>", [[<C-\><C-N><C-w>k]],
                            {noremap = true, silent = true})
    vim.api.nvim_set_keymap(value, "<M-l>", [[<C-\><C-N><C-w>l]],
                            {noremap = true, silent = true})
end
vim.api.nvim_set_keymap("t", "<Esc>", [[<C-\><C-n>]],
                        {noremap = true, silent = true})
-- Use alt + left,down,up,right to resize windows
vim.api.nvim_set_keymap("n", "<M-Up>", ":resize -2<CR>",
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap("n", "<M-Down>", ":resize +2<CR>",
                        {noremap = true, silent = true})
...
vim.api
    .nvim_set_keymap("n", "<C-q>", ":wq<CR>", {noremap = true, silent = true})
