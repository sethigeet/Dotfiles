...
vim.api.nvim_set_keymap("n", "<C-q>", ":lua ToggleQFList(1)<CR>", { noremap = true, silent = true })
-- Easily open the location list
vim.api.nvim_set_keymap("n", "<C-l>", ":lua ToggleQFList(0)<CR>", { noremap = true, silent = true })
