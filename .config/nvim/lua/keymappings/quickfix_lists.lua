...
vim.api.nvim_set_keymap("n", "<C-q>", ":call v:lua.ToggleQFList(1)<CR>", { noremap = true, silent = true })
-- Easily open the location list
vim.api.nvim_set_keymap("n", "<C-l>", ":call v:lua.ToggleQFList(0)<CR>", { noremap = true, silent = true })
