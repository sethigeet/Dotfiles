...
local mappings = {
  ...
  l = {
    name = "LSP",
    a = { ":Telescope lsp_code_action<CR>", "code actions" },
    A = { ":Telescope lsp_range_code_action<CR>", "range code actions" },
    ...
    p = {
      name = "Peek",
      d = { ":lua require('ui.peek').Peek('definition')<CR>", "definition" },
      t = { ":lua require('ui.peek').Peek('typeDefinition')<CR>", "type definition" },
      i = { ":lua require('ui.peek').Peek('implementation')<CR>", "implementation" },
    },
