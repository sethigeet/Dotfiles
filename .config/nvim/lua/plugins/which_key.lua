      ...
      spec = {
        {
          ...
          {
            "gp",
            function() require("lsp.helpers.peek").peek("definition") end,
          ...
          { "<leader>lp", group = "Peek", icon = { icon = "󰍉", color = "green" } },
          ...
          { "<leader>lpd", function() require("lsp.helpers.peek").peek("definition") end, desc = "Definition" },
          {
            "<leader>lpt",
            function() require("lsp.helpers.peek").peek("typeDefinition") end,
            desc = "Type Definition",
          },
          { "<leader>lpi", function() require("lsp.helpers.peek").peek("implementation") end, desc = "Implementation" },
