...
function lsp_wrapper.code_action() vim.lsp.buf.code_action() end
...
function lsp_wrapper.document_highlight() vim.lsp.buf.document_highlight() end

function lsp_wrapper.document_symbol() vim.lsp.buf.document_symbol() end

function lsp_wrapper.formatting() vim.lsp.buf.formatting() end

function lsp_wrapper.formatting_sync() vim.lsp.buf.formatting_sync() end

function lsp_wrapper.hover() vim.lsp.buf.hover() end

function lsp_wrapper.implementation() vim.lsp.buf.implementation() end
...
function lsp_wrapper.range_code_action() vim.lsp.buf.range_code_action() end

function lsp_wrapper.range_formatting() vim.lsp.buf.range_formatting() end
...
function lsp_wrapper.signature_help() vim.lsp.buf.signature_help() end

function lsp_wrapper.type_definition() vim.lsp.buf.type_definition() end
...
function lsp_wrapper.get_prev() vim.lsp.diagnostic.get_prev() end

function lsp_wrapper.goto_next() vim.lsp.diagnostic.goto_next() end
