# Generated by Powerlevel10k configuration wizard on 2020-11-01 at 16:17 IST.
...
() {
  ...
  # Red prompt symbol if not in insert mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VICMD,VIVIS,VIOWR}_FOREGROUND=196
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='[V] V'
