#+TITLE: Geet's Doom Emacs Config
#+AUTHOR: Geet Sethi
#+DESCRIPTION: Geets's personal Doom Emacs config.
...
- [[#move-blocks-of-code][MOVE BLOCKS OF CODE]]
...
I also changed the evil mode bindings from using <C-w>h/j/k/l to just use <C-h/j/k/l>
...
* MOVE BLOCKS OF CODE
I like to move selected blocks of code using "J" and "K" instead of M-j and M-k. But this keybinding will only work in visual mode. If you want to move it in any other mode, too bad!
...
* MISC KEYBINDINGS
  Some of the keybindings I like
